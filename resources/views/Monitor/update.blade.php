                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            <div class="form-group">
                                ...
                                {{ Form::text('project_name',$task->project_name,['class'=>'form-control','placeholder'=>'Enter Project Name...']) }}
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="form-group">
                                {{ Form::label('host','Host IP',['class'=>'control-label']) }}
                                <input type="text" class="form-control" id="host" value="{{ $task->host->ip }}" disabled>
                            </div>
                        </div>
                        <div class="col-lg-1">&nbsp;</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('monitor_path',$task->monitor_path,['class'=>'form-control','placeholder'=>'Click right Button and Choose Path...']) }}
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('white_path',$task->white_list,
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10">
                            <div class="form-group">
                                ...
                                {{ Form::text('black_extension',$task->black_list,
            ...
            new Vue({
                ...
                methods:{
                    send:function(){
                        ...
                        $.ajax({
                            url: '{{ url('monitor/task/update/'.$task->id) }}',
                            type:'POST',
                            data:{
