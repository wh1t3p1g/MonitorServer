        ...
        <div class="col-lg-12">
            <div class="box box-info">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            <div class="form-group">
                                ...
                                {{ Form::text('task_name',$task->task_name,['id'=>'task_name','class'=>'form-control','placeholder'=>'Enter Task Name...']) }}
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="form-group">
                                {{ Form::label('host','Host IP',['class'=>'control-label']) }}
                                <input id="host" type="text" class="form-control" value="{{ $task->host->ip }}" disabled>
                            </div>
                        </div>
                        <div class="col-lg-1">&nbsp;</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('file_path',$task->file_path,
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('except_path',$task->except_path,
                                        ['class'=>'form-control','placeholder'=>'Click right Button and Choose Path...']) }}
                                </div>
                            </div>
                            <div class="col-lg-2">
                ...
                <div class="box-footer" id="submit">
                    <a type="submit" class="btn btn-info pull-right" @click="send()">Renew</a>
                </div>
            <!-- /.box-footer -->
            </div>
        </div>
